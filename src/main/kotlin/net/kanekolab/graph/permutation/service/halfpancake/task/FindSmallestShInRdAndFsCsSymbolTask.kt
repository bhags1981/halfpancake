 ...
 */
class FindSmallestShInRdAndFsCsSymbolTask(currentGraph:HalfPancakeGraph, sourceNode:HalfPancakeNode,destinationNode: HalfPancakeNode) : ServiceTask<FindSmallestShInRdAndFsCsSymbolTask,Pair<String,String>>{
